...
public class AMZONReviewTestMozila {
    WebDriver driver;

    @Test
    public void landonpageM() throws InterruptedException, IOException {
        WebDriverManager.firefoxdriver().setup();
        driver = new FirefoxDriver();
        driver.get("https://www.amazon.in/");
        driver.manage().window().maximize();
        Thread.sleep(10000);
        System.out.println("Launched Amazon App in mozhila browser");
        ...
        String path = directory + File.separator + "AMZReview43AProFirefox.xlsx";
